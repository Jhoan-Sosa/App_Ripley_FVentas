...
class ApiClient {
  ...
  // ============================================================
  // 🔧 ELIGE UNA DE ESTAS OPCIONES (DESCOMENTA LA QUE USARÁS)
  // ============================================================
  ...
  // OPCIÓN 3: WiFi - Reemplaza con tu IP local (ejecuta 'ipconfig' en la terminal)
  // static const String baseUrl = 'http://192.168.1.35:8003';

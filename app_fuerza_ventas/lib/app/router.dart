...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      // ✅ RUTA PARA PENDIENTES DE APROBACIÓN (SUPERVISOR)
      GoRoute(
        path: '/pendientes',
      ...
      GoRoute(
        path: '/cartera',
        builder: (_, __) => const CarteraScreen(),
      ),
      GoRoute(
        path: '/ruta',
        builder: (_, __) => const RutaScreen(),
      ),
      GoRoute(
        path: '/alertas',
      ...
      GoRoute(
        path: '/campanas',
        builder: (_, __) => const CampanasScreen(),
      ),
      GoRoute(
        path: '/ficha',
      ...
      GoRoute(
        path: '/simulador',
        builder: (_, __) => const SimuladorScreen(),
      ),
      GoRoute(
        path: '/historial',
      ...
      GoRoute(
        path: '/desertor',
        builder: (_, __) => const DesertorScreen(),
      ),
      GoRoute(
        path: '/estado',
        builder: (_, __) => const EstadoScreen(),
      ),
      GoRoute(
        path: '/cobranza',
        builder: (_, __) => const CobranzaScreen(),
      ),
      GoRoute(
        path: '/reportes',

...
import '../../../shared/widgets/logo_ripley.dart';
          ...
          Consumer(
            builder: (context, ref, _) {
              ...
              return Padding(
                ...
                child: Text(
                  '${AppStrings.ultimaActualizacion}: $cuando',
                  style: const TextStyle(
                    fontSize: 11,
...
class _Lista extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget tarjeta(CarteraItem item) => ClienteCard(
      ...
      onTap: () => context.push('/ficha/${item.clienteId}', extra: item.id),
    );
    ...
    if (state.puedeReordenar) {
      return ReorderableListView.builder(
        ...
        onReorder: (oldIndex, newIndex) {
          // Ajuste para cuando se mueve hacia abajo
        ...
        itemBuilder: (context, i) {
          ...
          return Container(key: ValueKey(item.id), child: tarjeta(item));
        },
      );
    }
...
class _Drawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = <(IconData, String, String)>[
      ...
      if (perfil.puedeSupervisar)
        (Icons.gavel, 'Pendientes de aprobación', '/pendientes'), // ✅ AGREGAR
      if (perfil.puedeSupervisar) (Icons.bar_chart, 'Reportes', '/reportes'),
    ];
  ...
  Future<void> _cerrarSesion(
    ...
    try {
      ...
      /* si falla el conteo, continuamos con el cierre */
    }
